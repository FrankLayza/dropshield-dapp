...
const STEPS = [
  ...
  {
    number: 2,
    title: "Amounts securely hidden",
    body: "Allocations are secured before they ever leave your browser. On-chain: the numbers are completely hidden and unreadable by anyone.",
    img: "/illustrations/encrypted-enveil.png",
    imgAlt: "Encrypted amount and lock icon illustration",
  },
  {
    number: 3,
    title: "Recipients claim privately",
    body: "Each person opens their private link, reveals their own amount privately, and claims. On-chain: only that a claim happened.",
